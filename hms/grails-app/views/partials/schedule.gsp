								...
								<div class="modal-dialog" style="margin: 15% 30%;">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">&times;</button>
											<h4 class="modal-title" id="myModalLabel">Candidate
												Details</h4>
										</div>
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" data-dismiss="modal"
		ng-click="addCandidate()">Add Candidate</button>
</div>
</div>
</div>
</div>
...
<div class="col-md-5 col-md-offset-2">
	<label>Interview Mode</label> <select class="form-control"
		ng-model="selectedMode" ng-options="mode.name for mode in modes"></select>
</div>
...
<br>
<button type="submit" class="btn btn-primary" ng-click="setInterview()"
	ng-disabled="isSetInterviewDisabled">Set Interview</button>
<button type="reset" ng-click="clearForm()" class="btn btn-info">Clear</button>
</fieldset>
</form>
...
<div class="mygrid-wrapper-div">
	<table
		class="table table-striped table-condensed table-hover table-responsive ">
		<thead>
			<tr>
		...
		<tbody>
			<tr ng-repeat="interview in interviews">
				...
				<td><a href="#/scheduleRounds/{{interview.interviewId}}"
					tooltip="See Details" class="glyphicon glyphicon-time"></a></td>
				<td><button ng-hide={{interview.completionStatus}}
						type="button" tooltip="Delete"
						ng-click="deleteInterview(interview.interviewId)" class="close"
						style="color: red" aria-hidden="true">&times;</button></td>
			</tr>
		</tbody>
	</table>
