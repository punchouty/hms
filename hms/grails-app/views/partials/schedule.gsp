      ...
      <div class="row">
         <div class="col-md-5">
            ...
            <div class="input-group">
               ...
               <input class="form-control" ng-change="changeCandidate()" type="text" placeholder="Candidate Name...."
               ...
               <div class="modal-dialog" style="margin: 15% 30%;">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <div class="row">
                           <div class="col-md-5">
                              <b>Candidate Name<span class="required"></span>:</b>
                              <input ng-model="newName" type="text"/>
                           </div>
                           <div class="col-md-5">
                              <b>Unique Information <span class="required"></span>: </b>
                              <input type="text" ng-model="newInfo" ng-change="validateCandidate()"/>
                           </div>
                        </div>
                     </div>
                     <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                           ng-click="addCandidate()" ng-disabled="isAddCandidate">Add Candidate
                        </button>
                     </div>
                  </div>
               </div>
