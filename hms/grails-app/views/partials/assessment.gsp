<%--<h2>Perform Assessment</h2>--%>
   ...
   <li class="active">Perform Assessment</li>
   </ol>
 <br>
         <br><br>
         <b>Round: </b>{{round.roundName}}
     		<div class="row">
			         <div class="col-md-4">
					  ...
					  <div class="col-md-4 col-md-offset-4">
					            <div class="form-group">
						            <label>Rating</label>
									<select class="form-control" ng-model="round.rating">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									</select>
			  ...
			  <div class="row">
			   ...
			   <div class="row">
			   <div class="col-lg-8">
			 	 <button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="updateskill(evaluationSkillId,round)">Update score</button>
			  </div>
			  </div>
		<div class="col-md-4">
              <div class="form-group">
	    		...
	    		<table cellspacing="50" class="table table-striped table-condensed table-hover example">
	                ...
	                <tbody>
	                   <tr ng-repeat='skill in bucket.skillEval'>
							<td><a data-toggle="modal" data-target=".basicModal" ng-click="setSkillName(skill.skillName,skill.evaluationSkillId)">{{skill.skillName}}</a></td>
							<td>{{skill.weight}}</td>
